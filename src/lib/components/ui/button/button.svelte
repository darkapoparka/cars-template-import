	...
	export const buttonVariants = tv({
		...
		variants: {
			...
			size: {
				...
				sm: "h-10 gap-1.5 rounded-[min(var(--radius-md),12px)] px-3 text-[0.85rem] in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 [&_svg:not([class*='size-'])]:size-4",
